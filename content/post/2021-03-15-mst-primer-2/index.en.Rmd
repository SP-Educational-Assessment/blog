...
In the previous post on [previous post](/2021/03/08/mst-primer-1/) we considered some of the design considerations you need to think about when developing a new **multistage test** (MST).
...
```{r module-items, fig.cap = "MST Design with average difficulty levels", echo=FALSE}
